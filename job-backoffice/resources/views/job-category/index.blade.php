<x-app-layout>
    ...
    <div class="overflow-x-auto p-6">
        ...
        <div class="flex justify-end items-center">
            <a href="{{ route('job-categories.index', ['archived' => ' ']) }}" class="inline-flex items-center px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 mt-4 mr-4">
                Archived
            </a>
        </div>
